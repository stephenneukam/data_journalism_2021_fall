...
**Answer** Copy the url of the graphic you published here. https://datawrapper.dwcdn.net/68Rhb/1/
...
**Answer** Describe what the code below is doing and the output. This code is filtering out any counties that have a total of loan applications lower than six. This is because there are some entries in this set that are not counties in Maryland, including Middlesex and Fairfax, etc. The output will get rid of them.
...
The fips code column is not a combination of the state code and the county code.
...
We have the county name, the fips code and the total number of loans.
...
It now shows us just a map of Maryland, easier to read and see.
...
**Answer** Describe the changes from the previous map
The hover now shows the name of each county and the count for each county is standardized and easier to read.
...
**Answer** Put the URL of your map here. https://datawrapper.dwcdn.net/kyZa3/1/
