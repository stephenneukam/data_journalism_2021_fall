...
**Answer** The folder has a number of different files, including the shape file.
...
**Answer** It is a type of dataset we are familiar with. It has the name of the hospital, state, address, but it also has geomotry information.
...
**Answer** It is now just hospitals in Maryalnd.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows us the totals for each type of hospital in the state. General acute care is the most common.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now it shows us just the data for general acute care hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is a scatter plot that plots the location of the hospitals in long and lat. It roughly makes the shape of Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows us the geo info for each county in the U.S.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now we only have info for Maryland counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is the satte of Maryland on a plot of long and lat.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It has now plotted the hospitals on top of the Maryland counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is now much more descriptive. It maps the hospitals and breaks them down by how many beds each one has. However, this is sort of hard to read.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have info for all the hospitals in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the number of beds by each county in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It gives us the estimated population for each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** it gives us the geo info for each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is displaying the number of beds per county and the geo information for each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The population data is more clean. The selection below shows us county, population, and geo info.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It has joined the bed data with the pop data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It has replaced the N/As in the dataset with 0.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have calculated the per 100k of beds for each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the number of beds per 100k in each county, but the color scheme makes it hard to read.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It has changed the color scheme, making it a bit easier to read.
...
**Answer** The log makes the differences easier to see. 
