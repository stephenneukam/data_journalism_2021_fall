...
**Answer** The first line is grouping the dataset by the name of the counties. The second line is counting the total number of loans for each county. The third line is arranging it from least to greatest number of loans. The final line is showing us the top 10 results.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** It gives me a bar graph of loans totals with the x axis sorted in alphabetical order, but the names are overlapping.
...
**Answer** It has reordered the x axis from least to greatest
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The chart is now verticle, with the names much easier to read. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The names on the y axis are a bit more sleek. The boxes behind the bars are no longer grey.
...
**Answer** The colors of the chart have changed to reflect The Economist theme.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The names for the x and y axises have changed. The title of the chart is very bold. However, the names are in the wrong spots. They should be flipped for each axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see the total numbers of loans by each date, starting with April 3, 2020.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There is a line graph with each day plotted along the x axis and the volume of loans on the y axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The x axis is now broken up into each month with the year, but the text is overlapping like the charts above. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The dates are now slanted so that they are readable.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
