...
**Answer** It has vaccine information from each day from each county, dating back to last December.
...
**Answer** There are a large number of entries in the N/A and unknown categories
...
**Answer** It shows all of the data for entries that were N/A for county. The totals are super inconsistent. Some are 1 or 2, and others are in the hundreds.
...
**Answer** The dataframe shows the ranking for the days from PG County arranged chronologically. All of the last 7-10 days are ranked in the 200s, meaning there hasn't been a particularly high rate of vaccinations recently.
...
**Answer** It is showing vaccine totals in PG County over time. The trend is that the height of vaccines was between April and June and has since tailed off. 
...
**Answer** It is showing total case totals for each MD county over time.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The chart now differentiates the counties with the highes totals from those with the lowest totals. Still, the colors are difficult to read.
...
**Answer** There are 3233 rows in the counties dataframe.
...
**Answer** It is a choropleth map of case totals in Maryland.
