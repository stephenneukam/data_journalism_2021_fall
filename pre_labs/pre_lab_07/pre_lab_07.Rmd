...
The web page lists the NAICs codes and the industries that correlate to them. It also lists the conversion years when those codes changed. It also briefly describes the NAICs ID structure.
...
I see the html code that composes the webpage.
...
**Answer** The output below the codeblock is the beginning of each line of code (head, body) and is all on one line — too long to see in one R line.
...
I see the basic structure of the webpage (head, body) but none of the html elements appear in the dropdown menu.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The inspect button helped highlight the area in the HTML where this section was embedded.
...
**Answer** The function created dataframes for each <table> found in the html
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The environment lists each table under the dropdown menus but you cannot read them.
...
**Answer** It opens a dataframe that is readable and listed in a more usual way.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It shows the sector codes for each sector.
...
**Answer** Below the codeblock is now the naics codes that we wanted. 
...
**Answer** We now have a data frame that lists sector and description and have eliminated the url
...
**Answer** We have the final dataframe that we had above.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** There is a large amount of employment data in quite a few tables on the page.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** It is the same environment as above that is a list of two but is not a dataframe.
...
**Answer** It is a list of html elements under that id.
...
**Answer** It is a dataframe that shows the sectors and the employments numbers in certain months in 2021.
...
**Answer** It shows us just the amount of employees in June 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It is the same page but for the mining industry.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The same thing, but for the construction industry.
...
**Answer** It printed the value that we put after print each time.
```{r}
...
**Answer** It saved list of sectors as a value with each one that we wrote.
```{r}
...
**Answer** It printed each sector that we inputted in the list of sectors value.
```{r}
...
**Answer** It says that the object does not exist.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** It is the same as above.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** It says the object is not found.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** It printed numbers 1-10.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** It is a dataframe with each NAICs code and name.
...
**Answer** It prints each number of row in the dataframe.
...
**Answer** It gives us the employment number for June 2021.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** It gives us the sector number and the name.
```{r}
# Define url of page we want to scrape
...
**Answer** It creates the url and then fills in the sector number.
...
**Answer** It gives a unique xpath for each sector.
...
**Answer** It has taken away the public administration url
...
**Answer** It gives us 19 different dataframes.
...
**Answer** It gives us a unique URL for each row number
```{r}
...
**Answer** It gives us the complete employment data for each of the 19 sectors in 19 different dataframes.
...
**Answer** Individual tables of each employment datapoint.
...
**Answer** The dataframes now include which sector the information is for.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** It cleaned the dataset and narrowed the dataset to just the June 2021 employment for each sector.
...
**Answer** The 19 datasets are now in one environment.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It shows employment data for the mining sector. The same page we saw above.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The same page but for agriculture. However, it is structured differently.
...
**Answer** Agricutlure is now gone.
